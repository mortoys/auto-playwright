...
* Avoid using generic tags like 'h1' alone. Instead, combine them with other attributes or structural relationships to form a unique selector which is as specific and unambiguous as possible.
* Use descendant selectors, sibling selectors, and other advanced selectors as complex as possible to ensure uniqueness of the selection.
